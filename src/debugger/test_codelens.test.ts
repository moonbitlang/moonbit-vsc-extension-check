...
test("debug codelens", async () => {
  ...
  void vscode.commands.executeCommand("moonbit-lsp/test", {
    cwdUri: workspaceUri.toString(),
    backend: 'js',
    pkgPath: "username/hello/lib",
    fileName: "hello_test.mbt",
    index: 0,
    debug: true,
    update: false,
  });
